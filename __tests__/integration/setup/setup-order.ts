const setupOrderData = async (pg: any): Promise<void> => {
  ...
  await pg.query('CREATE TABLE "order" (id SERIAL PRIMARY KEY, code TEXT, client_cpf TEXT, coupon_id TEXT, total NUMERIC(10,2), created_at timestamp DEFAULT current_timestamp)');
